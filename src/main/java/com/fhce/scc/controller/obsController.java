...
public class obsController {
	...
	@PostMapping("/addObs")
    public ResponseEntity<obsDtoResponse> addObs(@RequestBody obsDtoRequest request) {
        try {
            obsDtoResponse resp = obsService.addObs(request);
    ...
    public ResponseEntity<obsDtoResponse> addObsAll(@RequestBody obsDtoRequest request) {
        try {
            obsDtoResponse resp = obsService.addObsAll(request);
