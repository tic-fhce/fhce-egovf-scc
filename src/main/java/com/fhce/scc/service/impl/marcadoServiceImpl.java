...
public class marcadoServiceImpl implements marcadoService{
	...
	@Transactional
	public marcadoDtoResponse addMarcado(marcadoDtoRequest marcadoDtorequest) {
		marcadoModel marcadoModel = this.modelMapper.map(marcadoDtorequest, marcadoModel.class);
		this.marcadoDao.save(marcadoModel);	
		return (this.modelMapper.map(marcadoModel, marcadoDtoResponse.class));
	}
